...
import { AccessibilityInfo, PanResponder, Animated, View, Text, Image, StyleProp } from "react-native";
...
type Props = StyleProp<CalendarList> & {
    /** the initial position of the calendar ('open' or 'closed') */
    // initialPosition?: oneOf(_.values(POSITIONS)),
    initialPosition?: any,
    ...
    leftArrowImageSource?: Record<string, any> | number | (() => React.ReactNode),
    /** source for the right arrow image */
    rightArrowImageSource?: Record<string, any> | number | (() => React.ReactNode),
    ...
    calendarStyle?: Record<string, any>,
 ...
 */
class ExpandableCalendar extends React.Component<Props, State> {
    ...
    renderKnob() {
        ...
        return (
            <View style={this.style.knobContainer} pointerEvents={"none"} testID={`${this.props.testID}-knob`}>
                <View style={this.style.knob} testID={testIDs.CALENDAR_KNOB} />
            </View>
        );
    }
