...
type Props = {
    state?: "selected" | "disabled" | "today" | "", //TODO: deprecate
    marking?: any,
...
export default class PeriodDay extends React.Component<Props> {
    ...
    getDrawingStyle(marking) {
        const defaultStyle: any = { textStyle: {}, containerStyle: {} };
    ...
    render() {
        ...
        let leftFillerStyle: any = {};
        let rightFillerStyle: any = {};
        let fillerStyle: any = {};
        let fillers;
