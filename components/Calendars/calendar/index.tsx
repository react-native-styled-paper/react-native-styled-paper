...
type Props = StyleProp<CalendarHeader> & StyleProp<Day> & {
    ...
    headerStyle?: Record<string, any> | number | any[],
        ...
        return (
            <View style={this.style.dayContainer} key={`week-container-${weekNumber}`}>
                <BasicDay
                    ...
                    testID={`${testIDs.WEEK_NUMBER}-${weekNumber}`}
                >
                    {weekNumber}
                </BasicDay>
            </View>
