...
import { FlatList, Platform, Dimensions, View, StyleProp } from "react-native";
...
type Props = StyleProp<Calendar> & {
    ...
    calendarStyle?: Record<string, any> | number | any[],
    ...
    onLayout?: (evt?) => void,
    onDayPress?: (evt?) => void,
    onVisibleMonthsChange?: (evt?) => void,
    ...
    onPressArrowLeft?: (evt?) => void,
    onPressArrowRight?: (evt?) => void,
    renderArrow?: (evt) => React.ReactElement,
};
