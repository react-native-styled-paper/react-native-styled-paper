...
type Props = ReactNative.StyleProp<CalendarList> & ReactNative.StyleProp<ReservationList> & {
    ...
    loadItemsForMonth?: (evt?) => void,
    /** callback that fires when the calendar is opened or closed */
    onCalendarToggled?: (evt?) => void,
    /** callback that gets called on day press */
    onDayPress?: (evt?) => void,
    /** callback that gets called when day changes while scrolling agenda list */
    onDaychange?: (evt?) => void, //TODO: Should be renamed 'onDayChange'
    /** specify how agenda knob should look like */
    renderKnob?: (evt?) => React.ReactNode,
    /** initially selected day */
    selected?: any, //TODO: Should be renamed 'selectedDay'
...
type State = {
    ...
    scrollY?: ReactNative.Animated.Value,
 ...
 */
export default class AgendaView extends React.Component<Props, State> {
    ...
    render() {
        ...
        return (
            <View testID={testID} onLayout={this.onLayout} style={[style, { flex: 1, overflow: "hidden" }]}>
                ...
                >
                    <View
                        testID={testIDs.AGENDA_CALENDAR_KNOB}
